...
{
    public static HTTR.Controllers.AccountController Account = new HTTR.Controllers.T4MVC_AccountController();
    public static HTTR.Controllers.HomeController Home = new HTTR.Controllers.T4MVC_HomeController();
    public static HTTR.Controllers.ManageController Manage = new HTTR.Controllers.T4MVC_ManageController();
...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static readonly string httr_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(UrlPath + "/httr.min.js") ? Url("httr.min.js") : Url("httr.js");
    ...
    public static class Content {
        ...
        public static class Images {
            ...
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
            public static readonly string ChrisThompson_png = Url("ChrisThompson.png");
            public static readonly string ColtMcCoy_png = Url("ColtMcCoy.png");
            public static readonly string DeSeanJackson_png = Url("DeSeanJackson.png");
            public static readonly string FatRobKelley_png = Url("FatRobKelley.png");
            public static readonly string JamisonCrowder_png = Url("JamisonCrowder.png");
            public static readonly string KirkCousins_png = Url("KirkCousins.png");
            public static readonly string logo_png = Url("logo.png");
            public static readonly string MattJones_png = Url("MattJones.png");
            public static readonly string NateSudfield_png = Url("NateSudfield.png");
            public static readonly string PierreGarcon_png = Url("PierreGarcon.png");
        }
    ...
    public static partial class Bundles
    {
        public static partial class Scripts 
        {
            public static class Assets
            {
                ...
                public const string httr_js = "~/Scripts/httr.js"; 
